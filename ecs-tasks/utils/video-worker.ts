...
const convertVideo = (format: format, folderPath: string, videoPath: string) => {
...
const { formatt, folderPath, videoPath } = workerData;

convertVideo(formatt, folderPath, videoPath)
  .then(() => {
